...
employee_router = APIRouter(
    prefix="/employee", tags=["Employee"], dependencies=[Depends(verify_access_token)]
)
...
async def delete_employee_address(
    ...
    await employee_service.delete_address(
        db=db, employee_id=employee_id, address_id=address_id
    )
